...
// Purpose: Primary sticky header/navigation bar across pages.
// Author: Principal Software Architect
// Dependencies: react, react-router-dom, useAuth, Button, api
// Used By: App.js
// Features: Real-time notification updates, avatar menu, active tab styles.
// Responsibilities: Topbar display, notification listings, profile menu access.
// ----------------------------------------------------------------------
...
/**
 * Topbar navigation menu component.
 *
 * Purpose:
 * Renders the top-level navigation, notification updates, and settings menu.
 *
 * Used By:
 * App.js (wraps around routes)
 */
